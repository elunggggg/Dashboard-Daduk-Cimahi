...
<head>
    ...
    <title>Masuk — DADUK Disdukcapil Kota Cimahi</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="card p-8">
            ...
            <div class="flex flex-col items-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Masuk ke DADUK</h1>
                <p class="text-sm text-gray-500 mt-1 text-center">
                    Dashboard Data Agregat Penduduk<br>Kota Cimahi
                </p>
            </div>
