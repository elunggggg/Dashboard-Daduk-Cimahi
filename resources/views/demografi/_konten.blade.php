{{-- Seluruh konten Halaman Demografi di bawah filter — diekstrak jadi partial
     ...
     (demografi/index.blade.php) maupun endpoint JSON (DemografiController,
     kunci 'konten_html'). Kanvas Chart.js di sini TETAP dirender apa adanya
     (id sama persis) — redraw-nya ditangani terpisah lewat
     gambarSemuaChart(d) di script, dibaca dari kunci 'charts' pada respons
     JSON, BUKAN dari @json(...) di partial ini (HTML hasil fetch di-inject
     lewat x-html, yang TIDAK mengeksekusi <script> apa pun di dalamnya). --}}
@if ($totalPenduduk === 0)
